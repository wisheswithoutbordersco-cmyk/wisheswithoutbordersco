...
const LIVE_BOOKS = [
  {
    ...
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663477175297/NToGAkZpVLAUzWzo.png",
    price: 999,
    badge: "Coming Soon",
    description:
    ...
    <div className="min-h-screen bg-[#F8F5EF]">
      ...
      <div className="bg-[#0A1A2F] text-white py-10 px-4 text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          <ChefHat className="w-6 h-6 text-[#C9A86A]" />
          <span className="text-[#C9A86A] font-semibold text-sm uppercase tracking-widest">Cookbooks</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {LIVE_BOOKS.map((book) => (
            ...
            >
              ...
              <div className="p-4">
                <p className="text-xs text-[#C9A86A] font-semibold mb-1">{book.subtitle}</p>
                <h3 className="text-sm font-bold text-[#0A1A2F] leading-tight mb-2">{book.name}</h3>
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-dashed border-[#C9A86A]/40">
            <div
              className="bg-[#F8F5EF] flex flex-col items-center justify-center"
              style={{ aspectRatio: "3/4" }}
            >
              <Clock className="w-10 h-10 text-[#C9A86A]/60 mb-2" />
              <p className="text-[#0A1A2F]/40 text-xs font-semibold">Coming Soon</p>
            </div>
            <div className="p-4">
              <p className="text-xs text-[#C9A86A] font-semibold mb-1">Desserts of the World</p>
              <h3 className="text-sm font-bold text-[#0A1A2F]/60 leading-tight mb-2">
