    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="pt-24 pb-12 px-4 text-center">
        ...
        <p className="text-white/60 text-lg max-w-2xl mx-auto">
          Offer comfort and remembrance across every culture. Culturally authentic designs to honor those we have lost.
        </p>
        <div className="mt-4 flex justify-center gap-6 text-sm text-white/50">
          <span>✉️ 182 Countries</span>
          <span>🕊️ Sympathy & Memorial</span>
